        ...
        <div class="w-full max-w-md bg-slate-900/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
            ...
            <div class="relative z-10">
                <div class="text-center mb-8">
                    <h2 class="text-3xl font-bold bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent mb-2">Welcome Back</h2>
                ...
                <form action="/login" method="POST" class="space-y-6">
                    ...
                    <div class="text-center text-sm text-slate-400 mt-6">
                        ...
                        <a href="/register" class="text-emerald-400 hover:text-emerald-300 font-medium transition-colors">Create one</a>
                    </div>
                </form>
            </div>
        </div>
